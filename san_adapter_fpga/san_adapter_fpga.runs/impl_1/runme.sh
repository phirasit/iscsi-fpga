...
HD_PWD='/home/phirasit/Project/san-adapter/san_adapter_fpga/san_adapter_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq7_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Zynq7_wrapper.tcl -notrace
