...
HD_PWD='/home/phirasit/Project/san-adapter/san_adapter_fpga/san_adapter_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq7_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq7_wrapper.tcl
