...
add_files -tb iscsi_hls/iscsi_processor/test/discovery_in.txt -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb iscsi_hls/iscsi_processor/test/iscsi_processor_tb.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
