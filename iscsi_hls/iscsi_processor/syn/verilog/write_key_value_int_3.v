...
wire   [31:0] select_ln185_1_fu_333_p3;
reg   [31:0] select_ln185_1_reg_456;
wire    ap_CS_fsm_state5;
wire   [31:0] length_fu_355_p2;
wire    ap_CS_fsm_state39;
wire   [31:0] length_3_fu_372_p2;
reg   [31:0] length_3_reg_469;
...
reg  signed [31:0] instance_data_length_4_reg_187;
...
wire   [28:0] tmp_3_fu_303_p4;
wire  signed [31:0] sext_ln185_1_fu_313_p1;
wire  signed [31:0] sext_ln185_2_fu_317_p1;
wire   [31:0] select_ln185_fu_320_p3;
wire   [31:0] sub_ln185_1_fu_327_p2;
...
iscsi_interface_srem_32s_5ns_6_36_seq_1 #(
    ...
    .din1_WIDTH( 5 ),
    .dout_WIDTH( 6 ))
iscsi_interface_srem_32s_5ns_6_36_seq_1_U84(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln183_fu_258_p2 == 1'd0))) begin
        ...
        tmp_2_reg_445 <= p_0_reg_166[32'd31];
...
assign add_ln190_fu_383_p2 = ($signed(instance_data_length_4_reg_187) + $signed(32'd1));
...
assign length_3_fu_372_p2 = ($signed(length_2_reg_196) + $signed(32'd4294967295));
...
assign select_ln185_1_fu_333_p3 = ((tmp_2_reg_445[0:0] === 1'b1) ? sub_ln185_1_fu_327_p2 : sext_ln185_2_fu_317_p1);

assign select_ln185_fu_320_p3 = ((tmp_2_reg_445[0:0] === 1'b1) ? sext_ln185_1_fu_313_p1 : sext_ln185_2_fu_317_p1);
...
assign sext_ln185_1_fu_313_p1 = $signed(tmp_3_fu_303_p4);

assign sext_ln185_2_fu_317_p1 = $signed(tmp_reg_451);

assign sext_ln188_fu_400_p0 = instance_data_length_i;

assign sext_ln188_fu_400_p1 = sext_ln188_fu_400_p0;

assign sext_ln190_fu_395_p1 = instance_data_length_4_reg_187;

assign sub_ln185_1_fu_327_p2 = (32'd0 - select_ln185_fu_320_p3);

assign sub_ln185_fu_298_p2 = (65'd0 - mul_ln185_reg_440);

assign tmp_3_fu_303_p4 = {{sub_ln185_fu_298_p2[64:36]}};
...
assign zext_ln188_fu_378_p1 = length_3_fu_372_p2;

endmodule //write_key_value_int_3
